...
def results_list():
    ...
    while trial < 40:
        response = requests.get("https://openpaymentsdata.cms.gov/resource/n2yr-3kx9.json", params=data)
...
def summary(physician_profile_id):
    ...
    response = requests.get("https://openpaymentsdata.cms.gov/resource/n2yr-3kx9.json", params=summ)
    search_results = response.json()
...
def ind_comparison(physician_profile_id, specialty, state, city):
    ...
    response = requests.get("https://openpaymentsdata.cms.gov/resource/n2yr-3kx9.json", params=summ, stream=True)
    ...
    record_same_city = requests.get("https://openpaymentsdata.cms.gov/resource/n2yr-3kx9.json", params=same_city, stream=True)
    ...
    for elem in selected_list:
        ...
        response1 = requests.get("https://openpaymentsdata.cms.gov/resource/n2yr-3kx9.json", params=data1)
