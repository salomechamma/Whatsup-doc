...
def connect_to_db(app, uri='postgresql:///doctors'):
    ...
    app.config['SQLALCHEMY_DATABASE_URI'] = uri or 'postgres://tkimqnptjojiod:0Vu834-tQ-RxDlPk4pXJoNzzBb@ec2-174-129-37-15.compute-1.amazonaws.com:5432/d5260ng66rqksh'
